...
- 284 toys. 246 have a tap action today; the other 38 only hop.
- **keep** (the effect is right: the owner liked it, or C2 finished it): 244.
- **more** (has an effect; make it clearer or more dramatic): 2.
- **new** (needs its own effect): 38.
...
- **C, polish.** Visual fixes still open: none. Done in C1: Cinnamon star cookie, Wooden elephant,
  ...
  Seashell spiral, Wizard's orb, Jellyfish, Pufferfish, Snail, Octopus, Fireworks, Decorated tree,
