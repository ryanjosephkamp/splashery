...
| 15 toys                       | Pack (Toys)           | Building bricks (pop them apart), rubber duck (squeak), spinning top, dice (roll), Newton's cradle, teddy bear (wave hello), yo-yo, puzzle cube (twist the top), spring toy (make it walk), kite, paper plane, origami crane, balloon dog, soap bubbles and a wind-up robot.                                                                                                                                   |
